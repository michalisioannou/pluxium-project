...
@Component({
  selector: 'app-accountsbreached',
  templateUrl: './accountsbreached.component.html',
  styleUrls: ['./accountsbreached.component.css'],
  animations: [
...
export class AccountsbreachedComponent {
