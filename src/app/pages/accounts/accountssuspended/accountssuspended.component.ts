...
@Component({
  selector: 'app-accountssuspended',
  templateUrl: './accountssuspended.component.html',
  styleUrls: ['./accountssuspended.component.css'],
  animations: [
...
export class AccountssuspendedComponent {
