...
@Component({
  selector: 'app-accountsinactive',
  templateUrl: './accountsinactive.component.html',
  styleUrls: ['./accountsinactive.component.css'],
  animations: [
...
export class AccountsinactiveComponent {
