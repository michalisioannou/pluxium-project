...
@Component({
  selector: 'table-expandable-rows-example2',
  styleUrls: ['./challengesctrader.component.css'],
  templateUrl: './challengesctrader.component.html',
  animations: [
...
export class ChallengesctraderComponent {
